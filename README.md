...
preventDefault এটি ব্রাউজারের কোনো এলিমেন্টের ডিফল্ট কাজ  হওয়া বন্ধ করে দেয়।
stopPropagation এটি ইভেন্টের বাবলিং  হওয়া বন্ধ করে দেয় যদি কোনো চাইল্ড এলিমেন্টে (যেমন বাটন) ক্লিক করেন, তবে সেই ক্লিক করার খবরটি আর তার প্যারেন্ট এলিমেন্টের (যেমন কার্ড বা মেইন সেকশন) কাছে যাবে না